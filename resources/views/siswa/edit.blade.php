        ...
        <div class="card-body">
            <form action="{{ route('siswa.update', $siswa->NRP) }}" method="POST" onsubmit="return validasiForm()">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Nama" id="Nama" class="form-control" maxlength="20" value="{{ old('Nama', $siswa->Nama) }}" placeholder="Masukkan nama lengkap">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Kelas" id="Kelas" class="form-control" maxlength="5" value="{{ old('Kelas', $siswa->Kelas) }}" placeholder="Contoh: PWEB">
                    </div>
                </div>
