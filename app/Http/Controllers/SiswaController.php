...
{
    //nama nama index, create dll bkn rumus tp bebas (tp harus konsisten)
    public function index()
    {
        $siswa = DB::table('siswa')->orderBy('NRP')->get();
        return view('siswa.index', compact('siswa')); // opsional. digunakan utk makin pendek codenya
    }
    ...
    {
        $request->validate([  // hanya jalan kalau ada illuminate validation rule
